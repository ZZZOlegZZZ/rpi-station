...
class initrzdSortRailNoPowMon extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'initrzdSortRailNoPowMon {--set_id=}';
    ...
    public function handle()
    {
        if (!$this->option('set_id')){
          $this->info('Необходимо указать id станции php artisan initrzdSortRailNoPowMon --set_id=xxx');
        }
