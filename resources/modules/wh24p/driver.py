...
where measured_at < DATETIME(datetime("now","-%s minute"))""" % (str(int(intv)-1))).fetchall()[0][0]) > 0
...
print("precipitation_intensity " + str(round(float(accumulated_data[3]) * (60/intv), 1)))
